    ...
    singleTargetList = singleTargetList or
        {
            ...
            function() if (not self.ComboFinisherAllowed and (not spells.FanTheHammer.Known or self.Player.Buffs:Stacks(spells.PistolShot.Opportunity) > 3)) then return self:PistolShot() end end,
            ...
            function() if (not self.ComboFinisherAllowed and (not spells.FanTheHammer.Known or self.ComboDeficit > 3)) then return self:PistolShot() end end,
